        ...
        <header className="bg-gray-50 px-5 py-12 rounded-md">
          <div className="max-w-7xl ">
            ...
            <p className="text-xl max-w-3xl text-gray-600">
              Your opinions help us improve. Share your thoughts, suggestions,
              and experiences to help us serve you better.
            </p>
          </div>
        </header>
                ...
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="item-2">
                    ...
                    <AccordionContent>
                      ...
                      identify areas for improvement, prioritize new features,
