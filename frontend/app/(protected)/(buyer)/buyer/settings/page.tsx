...
import AccountSettings from "@/app/(protected)/(seller)/seller/settings/components/account-settings";
import ForgotPassword from "@/app/(protected)/(seller)/seller/settings/components/forgot-password";
import PasswordManagement from "@/app/(protected)/(seller)/seller/settings/components/password-management";
import PaymentMethod from "@/app/(protected)/(seller)/seller/settings/components/payment-method";
