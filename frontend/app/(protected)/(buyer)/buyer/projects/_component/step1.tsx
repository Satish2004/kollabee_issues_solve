...
const Step1: React.FC<Step1Props> = ({ handleNext, errors, setErrors }) => {
  ...
  const renderCustomManufacturingForm = () => (
    <div className="space-y-6 font-futura  ">
      ...
      <div className="space-y-2">
        ...
        >
          <SelectTrigger className="w-full z-1000 bg-white ">
            <SelectValue placeholder="Select one or more relevant product types" />
          </SelectTrigger>
          <SelectContent className="bg-whtie z-1000">
            {productCategories["custom-manufacturing"].map((category) => (
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <Label
              ...
              className="text-sm  font-normal"
            >
              Slight modifications to an existing product (small changes, e.g.,
              color, size)
            </Label>
          </div>
          <div className="flex items-center space-x-2">
      ...
      <div className="space-y-2">
        <h1 className="text-2xl   mb-2">Product Requirements</h1>
      ...
      <div className="space-y-2">
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="design-yes" className="text-sm  font-normal">
              Yes, I need design services for my product or packaging (e.g.,
              logo, product design, packaging design).
            </Label>
          </div>
          <div className="flex items-center space-x-2">
        ...
        <p className="text-xs text-gray-500 italic mt-1">
          🛈 You can add a Services & Brand Support project after the completed
          one if needed.
        </p>
        {errors.needsDesign && (
          <p className="text-red-500 text-sm font-normal">
  ...
  const renderPackagingOnlyForm = () => (
    <div className="space-y-6 font-futura font-normal">
      <div className="space-y-2">
        <Label htmlFor="projectTitle" className="text-sm font-normal">
          Project Title<span className="text-[#EA3D4F]">*</span>
        </Label>
        <Input
          id="projectTitle"
          placeholder="What should we call this packaging project? (e.g., Eco-Friendly Skincare Box Packaging)"
          value={formData.projectTitle || ""}
          onChange={(e) => handleChange("projectTitle", e.target.value)}
          className="w-full"
        />
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(value) => handleChange("packagingCategory", value)}
        >
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          placeholder="This helps the supplier recommend the most suitable packaging materials, structure, and features based on your product type."
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="eco-yes" className="text-sm font-normal ">
              Yes – Please use sustainable materials (e.g., compostable,
          ...
          <label htmlFor="file-upload" className="cursor-pointer">
            <div className="flex flex-col items-center justify-center gap-2">
              ...
              <span className="text-sm font-normal text-gray-500">
                {uploading
                  ? "Uploading..."
                  : "Upload images, sketches, or examples of the type of packaging you're looking for"}
              </span>
            </div>
          </label>
        </div>
      ...
      <div className="space-y-2">
        <Label htmlFor="packagingDimensions" className="text-sm font-normal">
          Do you have any specific dimensions or functional requirements for
          your packaging?
          <span className="text-[#EA3D4F]">*</span>
        </Label>
        <Textarea
          id="packagingDimensions"
          placeholder="For example: bottle size (e.g., 150ml), box dimensions, resealable zipper, pump dispenser, dropper, tamper-evident seal, etc. Please provide dimensions in the format of Length (L) x Width (W) x Height (H) if applicable."
      ...
      <div className="space-y-2">
        <Label className="text-sm font-normal">
          Do you need labeling or printing services for your packaging?
          (optional)
        </Label>
        <RadioGroup
  ...
  const renderServicesBrandSupportForm = () => (
    <div className="space-y-6 font-futura font-normal">
      <div className="space-y-2">
        ...
        <Input
          id="projectTitle"
          placeholder="What should we call this project? (e.g., Brand Development for Eco-Friendly Skincare)"
          value={formData.projectTitle || ""}
          onChange={(e) => handleChange("projectTitle", e.target.value)}
          className="w-full"
        />
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          placeholder="Briefly describe the services or brand support you require. (e.g., Seeking a comprehensive brand strategy, including logo design, website development, and marketing strategy.)"
          ...
          <label htmlFor="file-upload" className="cursor-pointer">
            <div className="flex flex-col items-center justify-center gap-2">
              ...
              <span className="text-sm font-normal text-gray-500">
                {uploading
                  ? "Uploading..."
                  : "Include logos, moodboards, inspiration images, or other assets that help illustrate your brand's vision and style."}
              </span>
            </div>
          </label>
        </div>
  ...
  return (
    <div className="p-6 font-futura font-normal">
      <h1 className="text-2xl   mb-2">Project Details</h1>
