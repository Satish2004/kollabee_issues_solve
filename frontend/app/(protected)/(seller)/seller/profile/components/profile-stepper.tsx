...
const ProfileStepper = ({
  ...
  return (
    <div className="overflow-x-auto w-[75vw] mx-auto pb-4 relative custom-scrollbar" ref={stepperContainerRef}>
      <div className="flex">
        {steps.map((step, index) => {
          ...
          return (
            <div key={step.id} className="flex items-center mt-6" ref={index === activeStep ? activeStepRef : null}>
              <button
