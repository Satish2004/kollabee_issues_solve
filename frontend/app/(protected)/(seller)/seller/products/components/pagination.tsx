...
export default function Pagination({
  ...
  const getPageNumbers = () => {
    const pageNumbers = [];
    // Adjust max pages based on screen size
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4">
      ...
      <div className="flex sm:hidden items-center justify-center space-x-4 w-full">
        <button
          className="flex items-center justify-center px-3 py-2 rounded-md bg-gray-100 hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed"
          onClick={() => onPageChange(currentPage - 1)}
          disabled={currentPage === 1}
          aria-label="Previous page"
        >
