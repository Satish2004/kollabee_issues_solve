    ...
    <div className="space-y-8">
      ...
      <div className="space-y-8">
        <div className="space-y-4">
          <h3 className="font-bold">What Do You Aim to Achieve with KollaBee?</h3>
          <p className="text-sm text-muted-foreground">[Choose up to 3 options that best describe your goals.]</p>
            ...
            {objectives.map((objective) => (
              <div key={objective} className="flex items-start space-x-3">
                <Checkbox
                  ...
                  disabled={!formData.selectedObjectives.includes(objective) && formData.selectedObjectives.length >= 3}
                />
                <label
        ...
        <div className="space-y-4">
          <h3 className="font-bold">What Challenges Are You Looking to Overcome?</h3>
          <p className="text-sm text-muted-foreground">[Help us understand your pain points to provide better support.]</p>
          <div className="grid grid-cols-2 gap-3">
            {challenges.map((challenge) => (
              <div key={challenge} className="flex items-start space-x-3">
                <Checkbox
                  ...
                  disabled={!formData.selectedChallenges.includes(challenge) && formData.selectedChallenges.length >= 3}
                />
                <label
        ...
        <div className="space-y-4">
          <h3 className="font-bold">What Success Metrics Matter Most to You?</h3>
          <p className="text-sm text-muted-foreground">[Select the metrics you value the most in evaluating KollaBee's impact.]</p>
          <div className="grid grid-cols-2 gap-3">
            {metrics.map((metric) => (
              <div key={metric} className="flex items-start space-x-3">
                <Checkbox
                  ...
                  disabled={!formData.selectedMetrics.includes(metric) && formData.selectedMetrics.length >= 3}
                />
                <label
        ...
        <div className="space-y-3">
          <h3 className="font-bold">Agreement Statement:</h3>
