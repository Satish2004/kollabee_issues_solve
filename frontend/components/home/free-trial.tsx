      ...
      <div className="grid lg:grid-cols-2 gap-20">
        ...
        <div className="space-y-8">
          <div className="space-y-6">
            <div className="inline-block bg-gray-100 rounded-full px-4 py-1.5 text-sm">Contact Us</div>
            <h2 className="text-5xl leading-tight">Experience KollaBee with Our Free Trial Offer!</h2>
            <p className="text-gray-600">
              Sign up for our free trial to experience SAP's powerful project management features firsthand and
          ...
          <div className="space-y-4">
            {trialFeatures.map((feature, index) => (
              <div key={index} className="flex items-center gap-3 text-gray-600 border pl-2 py-2 pr-10 rounded-full w-fit border-[#E6E9EE]">
        ...
        <div className="space-y-4">
          <div className="aspect-video w-full rounded-2xl overflow-hidden bg-gray-100 h-[400px]">
            ...
            <Image
                src="/contact-image-kollabee.jpg"
                alt="Contact Us"
                width={500}
                height={400}
