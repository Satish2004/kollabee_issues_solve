    ...
    <footer className="w-full p-4">
      ...
      <div className=" mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-1">
              <p className="text-gray-800 font-medium">Empowering Your Projects,</p>
              <p className="text-gray-800 font-medium">Enhancing Your Success, Every</p>
              <p className="text-gray-800 font-medium">Step of the Way.</p>
            </div>

            {/* Social Media Icons */}
            <div className="flex gap-2">
              <Link href="#" className="bg-gray-800 text-white p-2 rounded-md hover:bg-gray-700">
                <Linkedin size={20} />
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="#" className="text-gray-800 hover:text-gray-900 text-sm">
                  Product Features
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            <div className="bg-gray-900 text-white p-4 rounded-lg">
              ...
              <div className="space-y-3">
                <Link href="#" className="flex items-center gap-3 bg-gray-800 p-3 rounded-md hover:bg-gray-700">
        ...
        <div className="mt-12 pt-6 border-t border-gray-500 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-800 font-semibold">© 2024 Sap. All rights reserved.</p>
          <Link href="/privacy-policy" className="text-sm text-gray-600 hover:text-gray-900 mt-2 md:mt-0">
            Privacy Policy
          </Link>
