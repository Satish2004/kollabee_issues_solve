                                ...
                                <div className="mt-2 space-y-2">
                                  {message.attachments.map((url, index) => {
                                    ...
                                    if (isImage) {
                                      return (
                                        <div key={index} className="relative rounded-lg overflow-hidden group">
                                          <img
                                            ...
                                            onClick={() => openMediaViewer(message.attachments, index)}
                                          />
                                      ...
                                      return (
                                        <div key={index} className="flex items-center p-2 bg-gray-200 rounded group">
                                          <Paperclip className="h-4 w-4 mr-2" />
                                          <span className="truncate flex-1">{url.split("/").pop() || "file"}</span>
                ...
                <PopoverContent className="w-auto p-0" align="start">
                  <Tabs defaultValue="recent">
                    ...
                    <TabsContent value="recent">
                      <RecentEmojis onEmojiSelect={(emoji) => handleEmojiSelect(emoji)} />
                    </TabsContent>
                    <TabsContent value="quick">
                      <EmojiQuickPicker onEmojiSelect={(emoji) => handleEmojiSelect(emoji)} />
                    </TabsContent>
