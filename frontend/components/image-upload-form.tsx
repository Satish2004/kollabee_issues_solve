...
export default function ImageUploadForm({propsSetDetailsUrl}:{propsSetDetailsUrl:(v:string[])=>void}) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {detailUrls.length > 0 && (
        <div>
          <h2 className="text-lg font-semibold mt-4">Detail Images URLs:</h2>
          <ul className="list-disc pl-5 flex flex-wrap w-full">
