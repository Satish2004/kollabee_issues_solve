...
router.get("/all-suppliers", adminController.getAllSuppliers);
...
router.get("/all-products", authMiddleware, adminController.getAllProducts);
router.get("/all-suppliers", authMiddleware, adminController.getAllSuppliers);  
router.get("/all-buyers", authMiddleware, adminController.getAllBuyers);
